...
- 必须自然带出学校、专业与年级(用半句话融入,如"悉尼大学电气工程AI方向在读",不必放第一句,也不许扩展成模板自报家门)。
- 允许并鼓励自然的开场姿态("您好"开头可以,禁止的只是"您好,我是XX学校XX专业学生"这种模板自报家门开场)。收尾必须是礼貌地请求沟通机会(如"不知是否方便进一步沟通"),而不是发起对等评估(禁止"聊聊匹配度""看看是否合适"这类表述)——评估是对方的事,候选人表达的是意愿和尊重。
